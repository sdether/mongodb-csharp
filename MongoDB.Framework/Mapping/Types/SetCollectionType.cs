...
namespace MongoDB.Framework.Mapping.Types
{
    public class SetCollectionType : ICollectionType
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SetCollectionType"/> class.
        /// </summary>
        /// <param name="elementValueType">Type of the element value.</param>
        public SetCollectionType(IValueType elementValueType)
        {
            ...
            this.CollectionType = typeof(HashSet<>).MakeGenericType(this.ElementValueType.Type);
