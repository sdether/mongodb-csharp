...
{
    public abstract class ClassMapBase : MapNode
    {
        ...
        protected ClassMapBase(Type type)
        {
            if (type == null)
        ...
        /// <param name="discriminator">The discriminator.</param>
        /// <returns></returns>
        public abstract ClassMapBase GetClassMapByDiscriminator(object discriminator);
